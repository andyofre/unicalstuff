            ...
            <div class="card">
                <div class="card-header d-flex justify-content-between">
                    <div class="header-title">
                        <h4 class="card-title h5 mt-2 py-1">List of All Courses Registered</h4>
                    </div>
                    <div class="">
                        <a href="{{route('courseCreate')}}" class="btn  btn-primary float-right">Add
                            Course</a>
                        ...
                        <table id="department" class="table data-table table-striped table-bordered">
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td>NGN {{number_format($course->course_amount)}}</td>
