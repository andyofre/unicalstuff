            ...
            <div class="form-row">
                <div class="col-md-6 mb-3 py-2">
                    ...
                    <input type="text" class="form-control  @error('name') is-invalid @enderror" id="
                        validationCustom01" name="name" value="{{$department->name}}" readonly>
                    @error('name')
                ...
                <div class="col-md-6 mb-3 py-2">
                    ...
                    <select id="" class="form-control @error('faculty_id') is-invalid @enderror" name="faculty_id">

                        <option selected-force>Select</option>

                        @foreach ( $faculty as $faculty)

                        <option value="{{$faculty->id}}" style="text-transform: uppercase;">
                            {{$faculty->name}}
                        </option>
                ...
                <div class="col-md-6 mb-3">
                    ...
                    <input type="text" class="form-control @error('accountName') is-invalid @enderror"
                        id="validationCustom02" name="accountName" value="{{$department->accountName}}">
                    @error('accountName')
                    <span class="invalid-feedback" role="alert">
                        <strong>{{ $message }}</strong>
                    </span>
                ...
                <div class="col-md-6 mb-3">
                    ...
                    <input type="text" class="form-control @error('accountNumber') is-invalid @enderror"
                        id="validationCustom02" name="accountNumber" value="{{$department->accountNumber}}">
                    @error('accountNumber')
                    <span class="invalid-feedback" role="alert">
                        <strong>{{ $message }}</strong>
                    </span>
                ...
                <div class="col-md-6 mb-3 m-10">
                    ...
                    <input type="date" id="" class="form-control @error('accountNumber') is-invalid @enderror"
                        name="date_created" readonly value="{{$department->date_created}}">
